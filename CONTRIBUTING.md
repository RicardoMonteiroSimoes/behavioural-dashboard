...
```sh
git clone https://github.com/RicardoMonteiroSimoes/behavioural-dashboard.git
cd behavioural-dashboard
npm install
```
...
This starts a Vite dev server at `http://localhost:5173` with abstract and dashboard modes for testing the engine in real time.
